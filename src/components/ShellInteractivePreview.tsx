...
export function ShellInteractivePreview() {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto rounded-2xl glass-panel p-2 border border-white/10 overflow-hidden shadow-2xl">
      ...
      {/* Preview Viewport */}
      <div className="p-6 bg-[#0F172A] font-mono text-xs sm:text-sm min-h-[380px] flex flex-col justify-between rounded-b-xl relative overflow-hidden">
        {/* CLI Tab Content */}
        {activeTab === "cli" && (
    ...
    "nsql_text": "WHEN body LIKE '%unsubscribe%' THEN MOVE TO 'Newsletters', SET read = TRUE WITH STOP PROCESSING;"
        ...
        {activeTab === "tui" && (
          <div className="space-y-2">
            <div className="bg-blue-900/50 text-blue-200 p-1.5 px-3 rounded flex justify-between font-bold">
              <span> NUNCIO v1.0.0 │ Status: Active (IMAP Syncing) │ Mode: AppMode::FilterRules </span>
              <span>[Acc: james.maes@kof22.com]</span>
            </div>
            <div className="grid grid-cols-12 gap-2 text-xs">
              <div className="col-span-5 bg-slate-900 p-3 rounded border border-yellow-500/30 space-y-1">
              ...
              <div className="col-span-7 bg-slate-900 p-3 rounded border border-cyan-500/30 space-y-2">
            ...
            <div className="bg-slate-800 text-slate-300 p-1 px-3 rounded text-xs flex justify-between">
        ...
        {activeTab === "gui" && (
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="bg-slate-900/90 p-3 rounded-xl border border-white/10 space-y-2">
              ...
              <div className="col-span-2 bg-slate-900/90 p-4 rounded-xl border border-white/10 space-y-3">
                ...
                <div className="flex gap-2">
                  <span className="px-3 py-1 rounded bg-blue-600 text-white font-semibold text-xs">Save Rule</span>
                  <span className="px-3 py-1 rounded bg-slate-800 text-slate-300 font-semibold text-xs">Test Dry-Run</span>
                </div>
              </div>
            </div>
          </div>
